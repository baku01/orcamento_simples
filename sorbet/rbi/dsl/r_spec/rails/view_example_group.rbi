...
# This is an autogenerated file for dynamic methods in `RSpec::Rails::ViewExampleGroup`.
# Please instead update this file by running `bin/tapioca dsl RSpec::Rails::ViewExampleGroup`.
